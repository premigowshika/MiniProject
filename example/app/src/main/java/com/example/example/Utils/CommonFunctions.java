...
import com.example.example.Account.LoginActivity;
import com.example.example.Complaints.ComplaintsActivity;
import com.example.example.AboutActivity;
import com.example.example.HomeActivity;
import com.example.example.Mess.MessActivity;
import com.example.example.R;
import com.example.example.Resources.ResourceActivity;
import com.example.example.Settings.SettingsActivity;
import com.example.example.User.ProfileActivity;
import com.example.example.User.UpdatePassword;
    ...
    public static boolean navigationItemSelect(MenuItem item, final Activity activity) {
        ...
        switch (id) {
            ...
            case R.id.nav_council: {
                ...
                activity.startActivity(new Intent().setClass(activity, AboutActivity.class));
                break;
            ...
            case R.id.nav_feedback: {
                String url = "https://docs.google.com/forms/d/e/1FAIpQLScmOt4CMiH0wV4Ya7TfXYlUj4fevo5S2_hLJ3AHjY5nsTEquQ/viewform?usp=sf_link";
