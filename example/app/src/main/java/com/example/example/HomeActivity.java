...
public class HomeActivity extends AppCompatActivity
    ...
    private ImageButton OutingImageBt;
    private ImageButton PayImageBt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OutingImageBt.setOnClickListener(this);
        PayImageBt.setOnClickListener(this);
    ...
    private void homeInit(){
        ...
        OutingImageBt = findViewById(R.id.imagebt_out);
        PayImageBt=findViewById(R.id.imagebt_pay);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.image_ec:
                ...
                break;
            case R.id.imagebt_out:
                startActivity(new Intent(HomeActivity.this, OutingActivity.class));
                break;

            case R.id.imagebt_pay:
